...
public sealed class ObjectPool : MonoBehaviour
{
    ...
    private static void FixShader(GameObject gameObj)
    {
         #if UNITY_EDITOR
        ...
        Renderer[] renderers = gameObj.GetComponentsInChildren<Renderer>(true);
...
public static class ObjectPoolExtensions
{
    ...
    {
        ObjectPool.Recycle(obj);
        //if (hero.HeroGame.Instance.IsUseCache)
        //    hero.HeroGame.Instance.SrcManager.RemoveAndCacheObject(obj);
        //else
